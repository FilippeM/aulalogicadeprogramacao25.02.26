...
//     anosExperiencia: lerTeclado.questionInt("Informe quantos anos possui de experiencia: "),
//     possuiEnsinoSuperior: lerTeclado.keyInYN("Possui ensino superior? [S/N]"),
//     possuiCursoTecnico: lerTeclado.keyInYN("Possui curso tecnico? [S/N]"),
//     resideNoBrasil: lerTeclado.keyInYN("Reside no Brasil? [S/N]")
// }

// let criteriosAprovacao = {
//     idadeValida: candidato.idade >= 18 && candidato.idade <= 40,
//     experienciaSuficiente: candidato.anosExperiencia > 2,
//     formacaoAdequada: candidato.possuiEnsinoSuperior === true || candidato.possuiCursoTecnico === true,
// }
// let candidatoAprovado = criteriosAprovacao.idadeValida && criteriosAprovacao.experienciaSuficiente && criteriosAprovacao.formacaoAdequada && candidato.resideNoBrasil


// console.table(candidato)
// console.table(criteriosAprovacao)
// let respVerd = `Parabéns, ${candidato.nome} Você está aprovado(a) para a próxima fase.`
// let respFalsa = `Infelizmente, ${candidato.nome}, seu perfil não atende aos requisitos desta vaga.`
// console.log(`${candidatoAprovado ? respVerd : respFalsa}`)
...
let temperaturaAtual = lerTeclado.questionFloat("Informe qual a temperatura atual: ")

let muitoFrio = temperaturaAtual < 10
let frio = temperaturaAtual >= 10 && temperaturaAtual < 18
let agradavel = temperaturaAtual >= 18 && temperaturaAtual <= 25
let quente = temperaturaAtual > 25 && temperaturaAtual <= 35
let muitoQuente = temperaturaAtual > 35

console.log(`Muito frio: ${muitoFrio? "Sim" : "Nao"}`)
console.log(`Frio: ${frio? "Sim" : "Nao"}`)
console.log(`Agradavel: ${agradavel? "Sim" : "Nao"}`)
console.log(`Quente: ${quente? "Sim" : "Nao"}`)
console.log(`Muito quente: ${muitoQuente? "Sim" : "Nao"}`)

let estaEmAmbienteInterno = lerTeclado.keyInYN("Voce esta em ambiente interno? [S/N]")

let precisaArCondicionado = temperaturaAtual > 28 && !estaEmAmbienteInterno
