...
let cores = ["Vermelho", "Azul", "Verde", "Branco"]
...
cores.shift(0)
console.log(cores)
console.log(`A quantidade de itens na lista cores é ${cores.length}.`)
...
let numeros = [28, 02, 2012, 777]
console.log(`Os valores armazenados são: ${numeros} e a quantidade de itens é: ${numeros.length}.`)
...
let tiposdados = [777, "HelloWorld", true, null, undefined]
...
let variedades = ["hello", 8, true, null]
console.log(variedades)
variedades.shift()
variedades.pop()
console.log(variedades)
variedades.push(false)
variedades.unshift("bye")
console.log(variedades)
...
console.log(nomes.includes("Filippe"))
...
console.log(letras3)  // respondido atividade "a"

console.log(letras3.slice(2,3))
