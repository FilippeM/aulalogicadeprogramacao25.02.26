...
// let numeroUsuario = lerTeclado.questionInt("Digite um numero inteiro: ")
// let resultado;
...
// let numeroInt = lerTeclado.questionInt("Digite um numero inteiro positivo: ")
// let soma = 0
...
// if(numeroInt > 0){
//     console.log(`Soma de 1 a ${numeroInt} é: ${soma}`)
// }
...
// let numeroIntFatorial = lerTeclado.questionInt("Digite um numero inteiro de 1 a 10: ")
// let resultadoFatorial = 1

// if(numeroIntFatorial <= 0 || numeroIntFatorial > 10){
//     console.log("Numero Invalido")
// }else {
//     for(i = 2; i <= numeroIntFatorial; i++ ){
//         resultadoFatorial *= i;
//     }
// }

// if(numeroIntFatorial > 0 && numeroIntFatorial <= 10){
//     console.log(`${numeroIntFatorial}! = ${resultadoFatorial}`)
// } 

// tive dificuldade de entender a logica do fatorial para fazer este exercicio. precisei de ajuda de IA
