...
const heroi = {
  ...
  console.log("╔══════════════════════════╗");
  console.log("║   BEM VINDO(A) AO TIBIA  ║");
  console.log("╚══════════════════════════╝");
  
  // Peça o nome do herói e exiba as regras do jogo resumidamente.
  // → Seu código aqui:

  let nickName = lerTeclado.question("Digite o nick do seu personagem: ");
  heroi.nome = nickName

  console.log(`
  \n====  REGRAS  =====================================================
  SEU PERSONAGEM IRA INICIAR UMA SEQUENCIA DE BATALHAS
  A CADA TURNO VOCE PODERA ESCOLHER APENAS UMA ACAO [ATK/DEF/HEAL]
  SE VOCE VENCER A BATALHA, IRA RECUPERAR 25 DE HP
  SE PERDER, O JOGO TERMINA
  ...
  // → Seu código aqui:
  console.log("ESCOLHA QUAL SERA SUA ACAO NESTE TURNO: ");
  console.log("1 - ATACAR ");
  console.log("2 - DEFENDER ");
  console.log("3 - CURAR "); 
  
  let acao = lerTeclado.questionInt("Digite sua escolha: ")
  let escolhaTurno = acao
  let dano = 0


switch(escolhaTurno){
    case 1:
        dano = (Math.floor(Math.random() * ( 25 - 15)) + 15);
        console.log(dano);
        break;
    case 2:
        break;
