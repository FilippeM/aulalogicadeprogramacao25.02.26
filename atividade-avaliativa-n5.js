...
if(cliente.orcamento > 3 || cliente.orcamento <= 0){
    console.log("Opção inválida. Encerrando o formulário.") //usuario entra nesta mensagem caso digite uma numeracao invalida no orcamento.
}else{
    ...
    console.log(3, "Temperado / Ameno") //caso contrario aparece as primeiras opcoes de escolha de clima.

    resp1 = lerTeclado.questionInt("Digite o numero da sua escolha: ") // capta resposta do usuario referente ao clima.
...
}// estrutura feita para dar opcoes de escolha de acordo ao clima escolhido.
